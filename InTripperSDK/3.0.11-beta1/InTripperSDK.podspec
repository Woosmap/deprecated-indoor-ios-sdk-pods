...
5.	Trigger proximity alerts at geo-fenced zones.
  ...
  s.homepage     = "http://www.intripper.com"
...
#s.license      = "Copyright"
s.license      = { :type => "Copyright", :file => "FILE_LICENSE", :text=> " Copyright © 2017-18 Intripper. All rights reserved." }
  ...
  s.author             = { "intripperteam" => "contact@intripper.com" }
  ...
  s.source       = { :git => "https://github.com/sanginfolbs/intripperIosSdk.git", :tag => "3.0.11-beta1" }
